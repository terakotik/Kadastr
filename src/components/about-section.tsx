      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
                 <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Татьяна Тюрина — ваш <span className="text-primary">надёжный партнёр</span> в мире кадастра</h2>
                 <p className="text-muted-foreground mb-4">
                  Я, Татьяна Тюрина, кадастровый инженер с более чем 15-летним опытом работы в сфере землеустройства и недвижимости. С 2011 года я помогаю своим клиентам в сложных вопросах, связанных с кадастровым учётом и регистрацией прав.
                </p>
