        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
                ...
                <p className="text-muted-foreground">
                   За это время я оформила более 2 000 объектов, включая земельные участки, жилые и нежилые строения, а также линейные объекты.
                   Моя цель — минимизировать ваше участие в процессе, выполняя большинство работ удалённо, чтобы вы могли сэкономить своё время и силы.
                </p>
